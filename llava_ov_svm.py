...
import json
import torch
from llava_ov_preprocess import measure_peak_memory, build_model, load_image_patches
...
def main():
    ...
    # ── 2. 載入圖像與問題 ──
    if args.use_ds:
        from llava_ov_preprocess import load_mmmu
        datasets = load_mmmu(num_image=args.num_images)
    else:
        from llava_ov_preprocess import load_local
